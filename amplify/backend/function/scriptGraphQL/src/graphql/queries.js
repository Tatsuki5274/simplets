...
`;
exports.getSheet = `
  query GetSheet($sub: String!, $year: Int!) {
    getSheet(sub: $sub, year: $year) {
      sub
      year
      companyID
      grade
