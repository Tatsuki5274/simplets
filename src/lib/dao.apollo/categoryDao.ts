...
export const CategoryDao = {
  create: async (mutation: string, params: APIt.CreateCategoryInput): Promise<Category | null> => {
    try {
      ...
      }) as ApolloQueryResult<APIt.CreateCategoryMutation>;
      if (createR.data) {
  ...
  update: async (mutation: string, params: APIt.UpdateCategoryInput): Promise<Category | null> => {
    try {
      ...
      const updateR = await client.mutate({
        ...
        variables: updateMV,
        fetchPolicy: 'no-cache',
      }) as ApolloQueryResult<APIt.UpdateCategoryMutation>;
      if (updateR.data) {
  ...
  delete: async (mutation: string, params: APIt.DeleteCategoryInput): Promise<Category | null> => {
    try {
      ...
      const deleteR = await client.mutate({
        ...
        variables: deleteMV,
        fetchPolicy: 'no-cache',
      }) as ApolloQueryResult<APIt.DeleteCategoryMutation>;
      if (deleteR.data) {
  ...
  get: async (query: string, params: APIt.GetCategoryQueryVariables): Promise<Category | null> => {
    try {
      ...
      }) as ApolloQueryResult<APIt.GetCategoryQuery>;
      if (getGQL.data) {
  ...
  list: async (query: string, params: APIt.ListCategorysQueryVariables): Promise<Category[] | null> => {
    try {
      ...
      const listGQL = await client.query({
        ...
        variables: listQV,
        fetchPolicy: 'network-only',
      }) as ApolloQueryResult<APIt.ListCategorysQuery>;
      if (listGQL.data) {
