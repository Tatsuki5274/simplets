  ...
  create: async (mutation: string, params: APIt.CreateSectionInput): Promise<Section | null> => {
    try {
      ...
      const createR = await graphqlMutation
        <APIt.CreateSectionMutationVariables, APIt.CreateSectionMutation>
        (mutation, createMV)
      if (createR.data) {
  ...
  update: async (mutation: string, params: APIt.UpdateSectionInput): Promise<Section | null> => {
    try {
      ...
      const updateR = await graphqlMutation
        <APIt.UpdateSectionMutationVariables, APIt.UpdateSectionMutation>
        (mutation, updateMV)
      if (updateR.data) {
  ...
  delete: async (mutation: string, params: APIt.DeleteSectionInput): Promise<Section | null> => {
    try {
      ...
      const deleteR = await graphqlMutation
        <APIt.DeleteSectionMutationVariables, APIt.DeleteSectionMutation>
        (mutation, deleteMV)
      if (deleteR.data) {
  ...
  get: async (query: string, params: APIt.GetSectionQueryVariables): Promise<Section | null> => {
    try {
      ...
      const getGQL = await await graphqlQuery
        <APIt.GetSectionQueryVariables, APIt.GetSectionQuery>
        (query, getQV)
      if (getGQL.data) {
