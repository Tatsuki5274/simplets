  ...
  create: async (
    ...
    try {
      ...
      const createR = await graphqlMutation<
        APIt.CreateCompanyMutationVariables,
        APIt.CreateCompanyMutation
      >(mutation, createMV);
      if (createR.data) {
  ...
  update: async (
    ...
    try {
      ...
      const updateR = await graphqlMutation<
        APIt.UpdateCompanyMutationVariables,
        APIt.UpdateCompanyMutation
      >(mutation, updateMV);
      if (updateR.data) {
  ...
  delete: async (
    ...
    try {
      ...
      const deleteR = await graphqlMutation<
        APIt.DeleteCompanyMutationVariables,
        APIt.DeleteCompanyMutation
      >(mutation, deleteMV);
      if (deleteR.data) {
  ...
  get: async (
    ...
    try {
      ...
      const getGQL = await await graphqlQuery<
        APIt.GetCompanyQueryVariables,
        APIt.GetCompanyQuery
      >(query, getQV);
      if (getGQL.data) {
