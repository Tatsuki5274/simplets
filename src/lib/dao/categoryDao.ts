  ...
  create: async (
    ...
    try {
      ...
      const createR = await graphqlMutation<
        APIt.CreateCategoryMutationVariables,
        APIt.CreateCategoryMutation
      >(mutation, createMV);
      if (createR.data) {
  ...
  update: async (
    ...
    try {
      ...
      const updateR = await graphqlMutation<
        APIt.UpdateCategoryMutationVariables,
        APIt.UpdateCategoryMutation
      >(mutation, updateMV);
      if (updateR.data) {
  ...
  delete: async (
    ...
    try {
      ...
      const deleteR = await graphqlMutation<
        APIt.DeleteCategoryMutationVariables,
        APIt.DeleteCategoryMutation
      >(mutation, deleteMV);
      if (deleteR.data) {
  ...
  get: async (
    ...
    try {
      ...
      const getGQL = await await graphqlQuery<
        APIt.GetCategoryQueryVariables,
        APIt.GetCategoryQuery
      >(query, getQV);
      if (getGQL.data) {
  ...
  listCompany: async (
    ...
    try {
      ...
      const listGQL = await graphqlQuery<
        APIt.ListCategorysCompanyQueryVariables,
        APIt.ListCategorysCompanyQuery
      >(query, listQV);
      if (listGQL.data) {
        const listQ: APIt.ListCategorysCompanyQuery = listGQL.data;
        if (listQ.listCategorysCompany && listQ.listCategorysCompany.items) {
          const gotCategorysCompany = listQ.listCategorysCompany
            .items as Category[];
