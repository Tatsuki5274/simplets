  ...
  create: async (
    ...
    try {
      ...
      const createR = await graphqlMutation<
        APIt.CreateObjectiveMutationVariables,
        APIt.CreateObjectiveMutation
      >(mutation, createMV);
      if (createR.data) {
  ...
  update: async (
    ...
    try {
      ...
      const updateR = await graphqlMutation<
        APIt.UpdateObjectiveMutationVariables,
        APIt.UpdateObjectiveMutation
      >(mutation, updateMV);
      if (updateR.data) {
  ...
  delete: async (
    ...
    try {
      ...
      const deleteR = await graphqlMutation<
        APIt.DeleteObjectiveMutationVariables,
        APIt.DeleteObjectiveMutation
      >(mutation, deleteMV);
      if (deleteR.data) {
  ...
  get: async (
    ...
    try {
      ...
      const getGQL = await await graphqlQuery<
        APIt.GetObjectiveQueryVariables,
        APIt.GetObjectiveQuery
      >(query, getQV);
      if (getGQL.data) {
