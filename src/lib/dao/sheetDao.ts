  ...
  create: async (
    ...
    try {
      ...
      const createR = await graphqlMutation<
        APIt.CreateSheetMutationVariables,
        APIt.CreateSheetMutation
      >(mutation, createMV);
      if (createR.data) {
  ...
  update: async (
    ...
    try {
      ...
      const updateR = await graphqlMutation<
        APIt.UpdateSheetMutationVariables,
        APIt.UpdateSheetMutation
      >(mutation, updateMV);
      if (updateR.data) {
  ...
  delete: async (
    ...
    try {
      ...
      const deleteR = await graphqlMutation<
        APIt.DeleteSheetMutationVariables,
        APIt.DeleteSheetMutation
      >(mutation, deleteMV);
      if (deleteR.data) {
  ...
  listCompany: async (
    ...
    try {
      ...
      const listGQL = await graphqlQuery<
        APIt.ListSheetsCompanyQueryVariables,
        APIt.ListSheetsCompanyQuery
      >(query, listQV);
      if (listGQL.data) {
  ...
  listReviewee: async (
    ...
    try {
      ...
      const listRevieweeGQL = await graphqlQuery<
        APIt.ListSheetsRevieweeQueryVariables,
        APIt.ListSheetsRevieweeQuery
      >(query, listRevieweeQV);
      if (listRevieweeGQL.data) {
        const listRevieweeQ: APIt.ListSheetsRevieweeQuery =
          listRevieweeGQL.data;
        if (
          listRevieweeQ.listSheetsReviewee &&
          listRevieweeQ.listSheetsReviewee.items
        ) {
