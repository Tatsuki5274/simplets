  ...
  useEffect(() => {
    (async () => {
      ...
      if (
        ...
        currentUser &&
        res.statusValue === 10 &&
        res.revieweeUsername === currentUser.username
      ) {
      ...
      if (sheet) {
        if (sheet.secondUsername) {
          ...
          if (secondReviewer) {
            ...
            const topReviewerName = topReviewer
              ? `${topReviewer.lastName} ${topReviewer.firstName}`
              : null;
  ...
  if (sheet) {
    return (
      <PDFTemplete
        ...
        lastYearsAgoOverAllEvaluation={
          lastOverAllEvaluations && lastOverAllEvaluations[0]
            ? lastOverAllEvaluations[0]
            : null
        }
        twoYearsAgoOverAllEvaluation={
          lastOverAllEvaluations && lastOverAllEvaluations[1]
            ? lastOverAllEvaluations[1]
            : null
        }
