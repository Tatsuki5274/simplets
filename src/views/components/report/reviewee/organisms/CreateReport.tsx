...
import AsyncButton from "views/components/common/atoms/AsyncButton";
...
import RadioButtonSelect from "views/components/common/molecules/RadioButtonSelect";
import RequiredLabel from "views/components/common/molecules/RequiredLabel";
...
[作業状況]
${
  props.data.workStatus[
    props.data.workStatus.findIndex(
...
${routeBuilder.reviewerReportCommentPath(createdReport.id || "", hostUrl)}
