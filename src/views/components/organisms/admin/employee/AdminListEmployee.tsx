...
import RowListEmployee from "views/components/molecules/admin/RowListEmployee";
                    ...
                    return (
                        employee ?
                            <RowListEmployee
                                ...
                                manager={employee.manager === EmployeeType.SUPER_MANAGER ? "部門長" : employee.manager === EmployeeType.MANAGER ? "所属長" : ""}
                            />
                            : null
                    )
                })}
