      ...
      <Table bordered>
        <thead>
          <tr>
            ...
            <TableHeaderCell>{`前期評価(${
              props.selectedYear - 1
            }年度)`}</TableHeaderCell>
            <TableHeaderCell>{`前々期評価(${
          ...
          {props.data.map((evaluationList) => {
            ...
            return (
              <tr key={evaluationList?.username}>
                ...
                <TableBodyCell>
                  {evaluationList?.overAllEvaluation
                    ? String(evaluationList.overAllEvaluation)
                    : "未評価"}
                </TableBodyCell>
                <TableBodyCell>
                  {evaluationList?.lastYearsAgoOverAllEvaluation
                    ? String(evaluationList.lastYearsAgoOverAllEvaluation)
                    : "未評価"}
                </TableBodyCell>
                <TableBodyCell>
                  {evaluationList?.twoYearsAgoOverAllEvaluation
                    ? String(evaluationList.twoYearsAgoOverAllEvaluation)
                    : "未評価"}
                </TableBodyCell>
                <TableBodyCell>
